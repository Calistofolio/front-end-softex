...
export function Title(){
    ...
    const titleChangeHandler = () =>{    
        const inputText = document.querySelector("#titleContent")  as HTMLInputElement
        if(!inputText) return;
    ...
    return(
        <div>
            ...
            <form onSubmit={submitHandler}>
                <input id="titleContent" type="text" placeholder="Digite o novo título" className="border border-black rounded"/>
